                                ...
                                <div className="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                                    <div className="card bg-light">
                                        ...
                                        <div className="card-body pt-0">
                                            <div className="row">
                                                <div className="col-7">
                                                    <h2 className="lead"><b>Charles Atangui</b></h2>
                                                    <ul className="ml-4 mb-0 fa-ul text-muted">
                                                        ...
                                                        <li className="small"><span className="fa-li"><i
                                                            className="fas fa-lg fa-phone"></i></span> Phone #: + 800 -
                                                            12 12 23 52
                                                        </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div className="card-body pt-0">
                                            <div className="row">
                                                <div className="col-7">
                                                    ...
                                                    <p className="text-muted text-sm"><b>Nombre de ticket: </b> <span
                                                        className="float-right badge bg-info">842</span></p>
                                                    <ul className="ml-4 mb-0 fa-ul text-muted">
                                                        <li className="small"><span className="fa-li"><i
                                                            className="fas fa-lg fa-building"></i></span> Address: Demo
                                                            Street 123, Demo City 04312, NJ
